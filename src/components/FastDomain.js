...
import {
  getDomain,
  getConnectedAddressDomain,
  mintToken,
  getAllregisteredDomains,
  approve,
  isDomainRegistered,
  reassignDomain,
} from "../utils/fastDomain";
  ...
  const registerFastDomain = async (
    ...
    try {
      await performActions(async (kit) => {
        ...
        await fastDomainContract.methods
          .registerFastDomain(_domainName)
          .send({ from: defaultAccount });
        toast(
          <NotificationSuccess
            text={<span>{_domainName} registered successfully &#127881;</span>}
          />
        );
      });
    } catch (e) {
  ...
  const getdomain = async () => {
    ...
    try {
      ...
      if (value === "") {
        toast(
          <NotificationSuccess
            text={<span> {reqAddress} is not registered &#127881;</span>}
          />
        );
      } else {
        toast(
        ...
        <div>
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <p className="card-text">
                          {" "}
                          Our mission is to simplify blockchain transactions by
                          providing a user-friendly Naming Service (FastDomain)
                          app for CELO blockchain. We aim to enhance
                          accessibility and ease of use for users, enabling them
                          to interact with the decentralized web seamlessly.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div className="card">
                      ...
                      <div className="card-body">
                        ...
                        <p className="card-text">
                          {" "}
                          Our vision is to empower individuals and businesses by
                          enabling them to have personalized and easily
                          ...
                          growth of the decentralized web ecosystem. Ultimately,
                          we envision a future where blockchain addresses are
                          replaced by human-readable names, making
                          cryptocurrency transactions more accessible and
          ...
          <footer id="footer">
            <div className="container">
              ...
              Designed by <a href="https://github.com/Sayrarh">Sayrarh</a>
            </div> */}
            </div>
          </footer>
          {/* End #footer */}
